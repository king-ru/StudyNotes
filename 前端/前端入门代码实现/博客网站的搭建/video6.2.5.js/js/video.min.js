! function(t, e) {
	...
	function C(t) {
		...
		if(t && t.attributes && t.attributes.length > 0)
			for(var n = t.attributes, r = n.length - 1; r >= 0; r--) {
				var i = n[r].name,
					o = n[r].value;
				"boolean" != typeof t[i] && -1 === ",autoplay,controls,loop,muted,default,".indexOf("," + i + ",") || (o = null !== o), e[i] = o
			}
		return e
	}
	...
	function qt() {
		...
		if("string" == typeof a) qt(t, Lr[a], n, i, o, s);
			...
			c.setSource(r({}, t), function(e, r) {
				...
				o.push(c), qt(r, t.type === r.type ? l : Lr[r.type], n, i, o, s)
			})
	...
	var Ln = function(t, e) {
		...
		Bn = function(t) {
			...
			return De(e, t), e.prototype.addTrack = function(e) {
				var n = this;
				e.enabled && Ln(this, e), t.prototype.addTrack.call(this, e), e.addEventListener && e.addEventListener("enabledchange", function() {
		...
		dr = function(t) {
			function e() {
				...
				return "disabled" !== s && l.tech_.ready(function() {
					...
					set: function() {}
				}), o.src ? (l.src = o.src, pr(o.src, l)) : l.loaded_ = !0, r = l, Re(n, r)
			}
	...
	}, bn.registerComponent("Tech", Rr), Rr.registerTech("Tech", Rr), Rr.defaultTechOrder_ = [];
	var Lr = {},
		Br = {
			buffered: 1,
			currentTime: 1,
	...
	var Ci = function(t) {
		function e(n) {
			var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			return Ie(this, e), r.tracks = n.textTracks(), Re(this, t.call(this, n, r))
		}
	...
	var Oi = function(t) {
		function e(n) {
			var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			return Ie(this, e), r.tracks = n.audioTracks(), Re(this, t.call(this, n, r))
		}
		return De(e, t), e.prototype.buildCSSClass = function() {
		...
		Zi = function(t) {
			...
			return De(e, t), e.prototype.dispose = function() {
				...
				for(var s = ["autoplay", "preload", "loop", "muted", "playsinline"], a = s.length - 1; a >= 0; a--) {
					var l = s[a],
						c = {};
					void 0 !== this.options_[l] && (c[l] = this.options_[l]), T(t, c)
				}
				return t
	...
	Zi.patchCanPlayType = function() {
		...
		e.setSrc(t.src)
	}, Zi.nativeSourceHandler.dispose = function() {}, Zi.registerSourceHandler(Zi.nativeSourceHandler), Rr.registerTech("Html5", Zi);
	var io = Le(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
		...
		so = function(t) {
			function e(n, i, o) {
				if(Ie(this, e), n.id = n.id || "vjs_video_" + R(), i = r(e.getTagSettings(n), i), i.initChildren = !1, i.createEl = !1, i.reportTouchActivity = !1, !i.language)
			...
			return De(e, t), e.prototype.dispose = function() {
				...
				this.tech_ = new a(s), this.tech_.ready(ln(this, this.handleTechReady_), !0), On.jsonToTextTracks(this.textTracksJson_ || [], this.tech_), oo.forEach(function(t) {
					...
					this.controls() && !this.usingNativeControls() && this.addTechControlsListeners_(), this.tech_.el().parentNode === this.el() || "Html5" === i && this.tag || y(this.tech_.el(), this.el()), this.tag && (this.tag.player = null, this.tag = null)
